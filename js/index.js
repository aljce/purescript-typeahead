...
(function(exports) {
      ...
      var setter = function (v) {
          return function (sOpts) {
              return new StateTA((function () {
                  var $20 = {};
                  for (var $21 in v.value0) {
                      if (v.value0.hasOwnProperty($21)) {
                          $20[$21] = v.value0[$21];
                      };
                  };
                  $20._showOptions = sOpts;
                  return $20;
              })());
          };
      };
  ...
  var mainCSS = function (dictStrong) {
      var setter = function (v) {
          return function (css) {
              return new StateTA((function () {
                  var $44 = {};
  ...
  var element = function (dictStrong) {
      var setter = function (v) {
          return function (elem) {
              return new StateTA((function () {
                  var $52 = {};
                  for (var $53 in v.value0) {
                      if (v.value0.hasOwnProperty($53)) {
                          $52[$53] = v.value0[$53];
                      };
                  };
                  $52._element = elem;
  ...
  var optionsStyle = Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.block))(function () {
      return Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
          return Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(CSS_Color.white))(function () {
              return Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(1.0))(CSS_Color.grey))(function () {
                  return CSS_Size.sym(CSS_Border.borderRadius)(CSS_Size.px(2.0));
              });
          });
      });
  });
  var inputStyle = Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
      return Prelude.bind(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
          return CSS_Size.sym(CSS_Geometry.padding)(CSS_Size.px(10.0));
      });
  });
...
(function(exports) {
  ...
  var search = function (substr) {
      var toEither = function (str) {
          ...
          throw new Error("Failed pattern match at TypeAhead.States line 28, column 9 - line 29, column 9: " + [ str.constructor.name ]);
      };
      var flags = (function () {
          var $2 = {};
          for (var $3 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($3)) {
                  $2[$3] = Data_String_Regex.noFlags[$3];
              };
          };
          $2.ignoreCase = true;
          return $2;
      ...
      var captured = "(" + (substr + ")");
      return function ($8) {
          return Prelude.map(Prelude.functorArray)(toEither)(Data_Array.filter(function ($9) {
              return !Data_String["null"]($9);
          })(Data_String_Regex.split(Data_String_Regex.regex(captured)(flags))($8)));
      };
  };
  ...
  var buildList = function (searchStr) {
      var bolden = function (v) {
          ...
          throw new Error("Failed pattern match at TypeAhead.States line 38, column 9 - line 39, column 9: " + [ v.constructor.name ]);
      };
      var toHtml = function (sections) {
          return Pux_Html_Elements.li([  ])(Prelude.map(Prelude.functorArray)(bolden)(sections));
      };
      return function ($10) {
          return Prelude.map(Prelude.functorArray)(toHtml)(Data_Array.filter(Data_Foldable.any(Data_Foldable.foldableArray)(Prelude.booleanAlgebraBoolean)(Data_Either.either(Prelude["const"](false))(Prelude["const"](true))))(Prelude.map(Prelude.functorArray)(search(searchStr))($10)));
      };
  };
  var renderOptions = function (searchStr) {
      return function (opts) {
          var renderedOpts = buildList(searchStr)(opts);
          var $7 = Data_Array["null"](renderedOpts);
          if ($7) {
              return Pux_Html_Elements.span([  ])([  ]);
          };
          if (!$7) {
              return Pux_Html.withChild(Pux_Html.withAttr(Pux_Html_Elements.div)(Pux_CSS.style(TypeAhead_Style.optionsStyle)))(Pux_Html_Elements.ul([  ])(renderedOpts));
          };
          throw new Error("Failed pattern match at TypeAhead.States line 43, column 32 - line 47, column 3: " + [ $7.constructor.name ]);
      };
  };
  var twitterTA = function (opts) {
      return new TypeAhead_Types.StateTA({
          _buildElem: Prelude.id(Prelude.categoryFn), 
          _mainCSS: TypeAhead_Style.inputStyle, 
          _element: "", 
...
(function(exports) {
  ...
  var Data_Lens_Getter = PS["Data.Lens.Getter"];
  var Data_Lens_Internal_Forget = PS["Data.Lens.Internal.Forget"];        
  var renderTA = function (state) {
      return Pux_Html.withChild(Pux_Html_Elements.div)(Pux_Html.withChild(Pux_Html.withAttr(Pux_Html_Elements.div)(Pux_CSS.style(Data_Lens_Getter["^."](state)(TypeAhead_Types.mainCSS(Data_Lens_Internal_Forget.strongForget)))))(Pux_Html.bind(Data_Lens_Getter["^."](state)(TypeAhead_Types.renderElem(Data_Lens_Internal_Forget.strongForget))(Data_Lens_Getter["^."](state)(TypeAhead_Types.element(Data_Lens_Internal_Forget.strongForget))))(function () {
          return Data_Lens_Getter["^."](state)(TypeAhead_Types.showOptions(Data_Lens_Internal_Forget.strongForget))(Data_Lens_Getter["^."](state)(TypeAhead_Types.element(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter["^."](state)(TypeAhead_Types.options(Data_Lens_Internal_Forget.strongForget)));
      })));
  };
...
(function(exports) {
  ...
  var main = function __do() {
      var v = Pux.start({
          ...
          view: TypeAhead_Render.renderTA, 
          inputs: [  ]
      })();
